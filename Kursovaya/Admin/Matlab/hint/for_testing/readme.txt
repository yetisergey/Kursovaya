...
hint_overview.html - HTML overview documentation file for the generated component. It 
                     contains the requirements for accessing the component and for 
                     generating arguments using the MWArray class hierarchy.

hint.xml - This file contains the code comments for the hint component classes and 
                     ...
                     online documentation for the hint component.
